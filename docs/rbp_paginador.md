...
Agregar páginas es muy sencillo, para esto se necesita de una plantilla que le permitirá agregar los campos y grupos de campos como se desee.
...
````js
$("[name='____NOMBRE_DE_SU_FORMULARIO____']").smallHelp({
    ruta_json:"___TU_RUTA_A_CARPETA_DE_JAVASCRIPTS___/RBNet/rbp-bootstrap-small-help/rbp-small-help-f1.json",
});
````
...
$.fn.smallHelp.defaults.ruta_json = "___TU_RUTA_A_CARPETA_DE_JAVASCRIPTS___/RBNet/rbp-bootstrap-small-help/rbp-small-help-f1.json"; 
